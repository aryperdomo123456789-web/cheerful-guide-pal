  ...
  head: () => ({
    meta: [
      ...
      { title: "Marcenaria Raiz — Móveis rústicos em madeira maciça" },
      {
        name: "description",
        content:
          "Marcenaria de móveis rústicos em madeira maciça e madeira de demolição: mesas, cristaleiras, buffets, armários e projetos sob medida.",
      },
      { name: "author", content: "Marcenaria Raiz" },
